...
const ProductDetails = () => {
    ...
    useEffect(()=>{setThumbnail(product?.image[0]?product.image[0]:null);
    },[])
                ...
                <div className="flex gap-3">
                    <div className="flex flex-col gap-3">
                        {product.image.map((image, index) => (
                            <div 
                            key={index} 
                            onClick={() => setThumbnail(`http://localhost:5000/images/${image}`)} className="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer" >
