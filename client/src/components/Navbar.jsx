              ...
              <Link to={"/products"}>All Products</Link>
                ...
                <div className="relative group">
                  <img src={assets.profile_icon} alt="" className="w-10"/>
                   <ul className="hidden group-hover:block absolute top-12 right-0 bg-white shadow-md rounded-md border border-gray-200 py-2 w-30 z-40 text-sm">
                    <li onClick={()=>{
                      navigate("/my-orders")
            ...
            <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
              ...
              <Link to={"/products"}>All Products</Link>
                ...
                <div className="relative group">
                  <img src={assets.profile_icon} alt="" className="w-10"/>
                  <ul className="hidden group-hover:block absolute top-12 right-0 bg-white shadow-md rounded-md border border-gray-200 py-2 w-30 z-40 text-sm">
                    <li onClick={()=>{navigate('/my-orders')}} className="p-1.5 cursor-pointer">My Orders</li>
